...
-- Insert countries into the countries table with their respective regions. --
...
-- Insert locations into the locations table with addresses and corresponding countries. --
...
-- Disable the foreign key constraint 'dept_mgr_fk' on the 'departments' table before making changes. --
ALTER TABLE departments DISABLE CONSTRAINT dept_mgr_fk;

-- Insert departments with their details. --
...
-- Insert jobs with titles and salary ranges. --
...
-- Insert employees with personal datas. --
...
-- Enable the foreign key constraint "dept_mgr_fk" on the "departments" table after making changes. --
ALTER TABLE departments ENABLE CONSTRAINT dept_mgr_fk;

-- Commit the transaction to save all changes made in the current transaction permanently to the database. --
COMMIT;
